...
(function () {
    var NewsApi = function () {
        function NewsApi(baseUrl, apiKey) {
        ...
        _createClass(NewsApi, [{
            ...
            value: function getSources() {
                ...
                fetch(this.baseUrl + '/sources?apiKey=' + this.apiKey).then(function (response) {
                    return response.json();
                }).then(function (data) {
                    return _this.renderSources(data.sources);
                }).then(function () {
                    return _this.addSelectListener();
                }).catch(alert);
            }
        }, {
            key: 'renderSources',
            value: function renderSources(sources) {
                ...
                sources.forEach(function (_ref) {
                    ...
                    var _ref2 = [id, name, description];
                    option.id = _ref2[0];
                    option.textContent = _ref2[1];
                    option.title = _ref2[2];
            ...
            value: function addSelectListener() {
                ...
                select.addEventListener("change", function () {
                    ...
                    if (select.selectedIndex) {
                        _this2.getNews(selectedSource.id);
                    } else {
            ...
            value: function getNews(source) {
                ...
                fetch(this.baseUrl + '/top-headlines?sources=' + source + '&apiKey=' + this.apiKey).then(function (response) {
                    return response.json();
                }).then(function (data) {
                    return _this3.renderArticles(data.articles);
                }).catch(alert);
            }
        }, {
            key: 'renderArticles',
            value: function renderArticles(articles) {
                ...
                articles.forEach(function (article) {
                    ...
                    articleWrapper.innerHTML = _this4.createArticle(article);
    ...
    var apiKey = "762fef256cf642a3bc9c21296a4ed824";

    var newsApi = new NewsApi(baseUrl, apiKey);
    newsApi.getSources();
})();

},{"babel-polyfill":1,"whatwg-fetch":326}]},{},[327]);
